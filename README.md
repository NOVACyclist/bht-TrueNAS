# NOVA's TrueNAS Edition
I'm updating this script slightly so that it'll work on an as-is Truenas 13.0 or newer system. No installs, no funny business. 
...
# REQUIREMENTS
The original author wrote bht on Linux with ksh93, so it requires the following to run:
